function createUnityInstance(canvas, config, onProgress) {
  ...
  function progressUpdate(id, e) {
    ...
    var CachedXMLHttpRequest = function () {
  ...
  function downloadBinary(urlId) {
    return new Promise(function (resolve, reject) {
      ...
      var xhr = Module.companyName && Module.productName && Module.cacheControl && (Module.cacheControl[urlId] || Module.cacheControl["default"]) ? new CachedXMLHttpRequest({
